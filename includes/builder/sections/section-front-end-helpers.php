 ...
 */
function maera_pb_builder_is_section_type( $type, $data ) {
	 ...
	 * @param array     $data               The section data.
	 */
	return apply_filters( 'maera_builder_is_section_type', $is_section_type, $type, $data );
}
 ...
 */
function maera_pb_builder_get_gallery_array( $maera_pb_section_data ) {
	if ( ! maera_pb_builder_is_section_type( 'gallery', $maera_pb_section_data ) ) {
		return array();
	}

	$gallery_order = array();
	if ( isset( $maera_pb_section_data['gallery-item-order'] ) ) {
		$gallery_order = $maera_pb_section_data['gallery-item-order'];
	}

	$gallery_items = array();
	if ( isset( $maera_pb_section_data['gallery-items'] ) ) {
		$gallery_items = $maera_pb_section_data['gallery-items'];
	}
	 ...
	 * @param array    $maera_pb_section_data    The section data.
	 */
	return apply_filters( 'maera_builder_get_gallery_array', $gallery_array, $maera_pb_section_data );
}
 ...
 */
function maera_pb_builder_get_gallery_class( $maera_pb_section_data, $sections ) {
	if ( ! maera_pb_builder_is_section_type( 'gallery', $maera_pb_section_data ) ) {
		return '';
	}
	...
	// Section classes
	$gallery_class .= maera_pb_get_builder_save()->section_classes( $maera_pb_section_data, $sections );

	// Columns
	$gallery_columns = ( isset( $maera_pb_section_data['columns'] ) ) ? absint( $maera_pb_section_data['columns'] ) : 1;
	$gallery_class  .= ' builder-gallery-columns-' . $gallery_columns;

	// Captions
	if ( isset( $maera_pb_section_data['captions'] ) && ! empty( $maera_pb_section_data['captions'] ) ) {
		$gallery_class .= ' builder-gallery-captions-' . esc_attr( $maera_pb_section_data['captions'] );
	}

	// Caption color
	if ( isset( $maera_pb_section_data['caption-color'] ) && ! empty( $maera_pb_section_data['caption-color'] ) ) {
		$gallery_class .= ' builder-gallery-captions-' . esc_attr( $maera_pb_section_data['caption-color'] );
	}

	// Aspect Ratio
	if ( isset( $maera_pb_section_data['aspect'] ) && ! empty( $maera_pb_section_data['aspect'] ) ) {
		$gallery_class .= ' builder-gallery-aspect-' . esc_attr( $maera_pb_section_data['aspect'] );
	}

	// Test for background padding
	$bg_color = ( isset( $maera_pb_section_data['background-color'] ) && ! empty( $maera_pb_section_data['background-color'] ) );
	$bg_image = ( isset( $maera_pb_section_data['background-image'] ) && 0 !== absint( $maera_pb_section_data['background-image'] ) );
	 ...
	 * @param array     $sections                The list of sections.
	 */
	return apply_filters( 'maera_gallery_class', $gallery_class, $maera_pb_section_data, $sections );
}
 ...
 */
function maera_pb_builder_get_gallery_style( $maera_pb_section_data ) {
	if ( ! maera_pb_builder_is_section_type( 'gallery', $maera_pb_section_data ) ) {
		return '';
	}
	...
	// Background color
	if ( isset( $maera_pb_section_data['background-color'] ) && ! empty( $maera_pb_section_data['background-color'] ) ) {
		$gallery_style .= 'background-color:' . maybe_hash_hex_color( $maera_pb_section_data['background-color'] ) . ';';
	}

	// Background image
	if ( isset( $maera_pb_section_data['background-image'] ) && 0 !== absint( $maera_pb_section_data['background-image'] ) ) {
		$image_src = Maera_PB_Image::get_image_src( $maera_pb_section_data['background-image'], 'full' );
	...
	// Background style
	if ( isset( $maera_pb_section_data['background-style'] ) && ! empty( $maera_pb_section_data['background-style'] ) ) {
		if ( 'cover' === $maera_pb_section_data['background-style'] ) {
	 ...
	 * @param array     $maera_pb_section_data    The section data.
	 */
	return apply_filters( 'maera_builder_get_gallery_style', $gallery_style, $maera_pb_section_data );
}
 ...
 * @return string                             The class.
 */
function maera_pb_builder_get_gallery_item_class( $item, $maera_pb_section_data, $i ) {
	if ( ! maera_pb_builder_is_section_type( 'gallery', $maera_pb_section_data ) ) {
		return '';
	}
	 ...
	 */
	return apply_filters( 'maera_builder_get_gallery_item_class', $gallery_class, $item, $maera_pb_section_data, $i );
}
 ...
 */
function maera_pb_builder_get_gallery_item_image( $item, $aspect ) {
	global $maera_pb_section_data;
	$image = '';

	if ( maera_pb_builder_is_section_type( 'gallery', $maera_pb_section_data ) && 0 !== maera_pb_sanitize_image_id( $item[ 'image-id' ] ) ) {
		$image_style = '';

		$image_src = Maera_PB_Image::get_image_src( $item[ 'image-id' ], 'large' );
		if ( isset( $image_src[0]  ) ) {
	 ...
	 * @param string    $aspect    The aspect ratio for the section.
	 */
	return apply_filters( 'maera_builder_get_gallery_item_image', $image, $item, $aspect );
}
 ...
 */
function maera_pb_builder_get_text_array( $maera_pb_section_data ) {
	...
	$columns_order = array();
	if ( isset( $maera_pb_section_data['columns-order'] ) ) {
		$columns_order = $maera_pb_section_data['columns-order'];
	}

	$columns_data = array();
	if ( isset( $maera_pb_section_data['columns'] ) ) {
		$columns_data = $maera_pb_section_data['columns'];
	}
	 ...
	 * @param array    $maera_pb_section_data    The raw section data.
	 */
	return apply_filters( 'maera_builder_get_text_array', $columns_array, $maera_pb_section_data );
}
 ...
 */
function maera_pb_builder_get_banner_array( $maera_pb_section_data ) {
	$banner_order  = array();
	$banner_slides = array();
	$banner_array  = array();

	if ( maera_pb_builder_is_section_type( 'banner', $maera_pb_section_data ) ) {
		if ( isset( $maera_pb_section_data['banner-slide-order'] ) ) {
			$banner_order = $maera_pb_section_data['banner-slide-order'];
		}

		if ( isset( $maera_pb_section_data['banner-slides'] ) ) {
			$banner_slides = $maera_pb_section_data['banner-slides'];
		}
	 ...
	 * @param array    $maera_pb_section_data    All of the data for the section.
	 */
	return apply_filters( 'maera_builder_get_banner_array', $banner_array, $maera_pb_section_data );
}
 ...
 * @return string                             The class.
 */
function maera_pb_builder_get_banner_class( $maera_pb_section_data, $sections ) {
	$banner_class = '';

	if ( maera_pb_builder_is_section_type( 'banner', $maera_pb_section_data ) ) {
		$banner_class .= ' ' . maera_pb_get_builder_save()->section_classes( $maera_pb_section_data, $sections );
	}
	 ...
	 * @param array     $maera_pb_section_data    The section data.
	 */
	return apply_filters( 'maera_builder_banner_class', $banner_class, $maera_pb_section_data );
}
 ...
 */
function maera_pb_builder_get_banner_slider_atts( $maera_pb_section_data ) {
	$data_attributes = '';
	 ...
	 * @param array     $maera_pb_section_data    The section data.
	 */
	return apply_filters( 'maera_builder_get_banner_slider_atts', $data_attributes, $maera_pb_section_data );
}
 ...
 */
function maera_pb_builder_banner_slide_class( $slide ) {
	$slide_class = '';
	 ...
	 */
	return apply_filters( 'maera_builder_banner_slide_class', $slide_class, $slide );
}
 ...
 */
function maera_pb_builder_banner_slide_style( $slide, $maera_pb_section_data ) {
	$slide_style = '';
	...
	// Background image
	if ( isset( $slide['image-id'] ) && 0 !== maera_pb_sanitize_image_id( $slide['image-id'] ) ) {
		$image_src = Maera_PB_Image::get_image_src( $slide['image-id'], 'full' );
		if ( isset( $image_src[0] ) ) {
	 ...
	 * @param array     $maera_pb_section_data    The section data.
	 */
	return apply_filters( 'maera_builder_banner_slide_style', esc_attr( $slide_style ), $slide, $maera_pb_section_data );
}
